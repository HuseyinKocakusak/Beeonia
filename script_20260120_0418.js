  ...
  (function initReviews() {
    const reviews = [
      ...
      },
      {
        name: "Yusuf Güdücü",
        commentTr:
          "Gerçek bir bilimcinin verdiği güven ve eşsiz lezzetiyle kahvaltıların Seda Sayanı. Emeğinize sağlık Ege Arıcılık 🐝",
        commentEn:
      ...
      },
      {
        ...
        commentTr:
          "Orjinal bal buna denir çocuklarımıza güvenle yediriyoruz ve yiyiyoruz şiddetle tavsiye ederim herkez bir şans verip almalı emeklerinize sağlık 👏👏",
        commentEn:
